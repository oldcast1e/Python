...
각도를 정수 값으로 변환하고, 한 줄에 각각의 각도를 출력합니다.
각 손 마디에 번호를 추가하고, 손 마디의 인덱스를 배열의 인덱스로 가지는 1차원 배열에 각도를 저장합니다.
출력은 1초에 한 번으로 제한합니다.
...
LANDMARK_INDEX_TO_NAME = {
    mp_hands.HandLandmark.WRIST: "손목",
    mp_hands.HandLandmark.THUMB_CMC: "엄지 기저부",
    mp_hands.HandLandmark.THUMB_MCP: "엄지 중간 관절",
    mp_hands.HandLandmark.THUMB_IP: "엄지 끝 관절",
    mp_hands.HandLandmark.INDEX_FINGER_MCP: "검지 중간 관절",
    mp_hands.HandLandmark.INDEX_FINGER_PIP: "검지 끝 관절",
    mp_hands.HandLandmark.MIDDLE_FINGER_MCP: "중지 중간 관절",
    mp_hands.HandLandmark.MIDDLE_FINGER_PIP: "중지 끝 관절",
    mp_hands.HandLandmark.RING_FINGER_MCP: "약지 중간 관절",
    mp_hands.HandLandmark.RING_FINGER_PIP: "약지 끝 관절",
    mp_hands.HandLandmark.PINKY_MCP: "소지 중간 관절",
    mp_hands.HandLandmark.PINKY_PIP: "소지 끝 관절",
}
